/***************************************************************************
                          arnCompositeArrayViewer.h  -  description
                             -------------------
...
#ifndef ArnCompositeArrayViewerH
#define ArnCompositeArrayViewerH
...
class arnCompositeArrayViewer : public arnObjectViewer
{
    Q_OBJECT
    ...
    public :
        ...
        arnCompositeArrayViewer(QWidget *parent = 0, const char *name = 0, Qt::WFlags f = 0);
        arnCompositeArrayViewer(int rows = 5, QWidget *parent = 0, const char *name = 0, Qt::WFlags f = 0);
        ~arnCompositeArrayViewer(void);
		...
		inline void setXMinScale(double val) {if (pGLArray) pGLArray->setXMinScale(val);}
		inline void setXMaxScale(double val) {if (pGLArray) pGLArray->setXMaxScale(val);}
		inline void setValueMinScale(double val) {if (pGLArray) pGLArray->setValueMinScale(val); }
		inline void setValueMaxScale(double val) {if (pGLArray) pGLArray->setValueMaxScale(val);}
		inline void setXAxisLabel(const QString& str) {if (pGLArray) pGLArray->setXAxisLabel(str);}
		inline void setYAxisLabel(const QString& str) {if (pGLArray) pGLArray->setYAxisLabel(str);}
		inline void setCaptionLabel(const QString& str) {if (pGLArray) pGLArray->setCaptionLabel(str);}
