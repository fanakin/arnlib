/***************************************************************************
                          arnNumericArrayViewer.cpp  -  description
                             -------------------
...
#include "arnNumericArrayViewer.h"
#include <QContextMenuEvent>

arnNumericArrayViewer::arnNumericArrayViewer(int rows, QWidget *parent, const char *name, Qt::WFlags f)
    : arnObjectViewer(parent, name, f)
{
    ...
    pComment = new QLabel("Prova Commento",this,"Comment",0);
...
arnNumericArrayViewer::arnNumericArrayViewer(QWidget *parent, const char *name, Qt::WFlags f)
    : arnObjectViewer(parent, name, f)
{
    tpy = avt_NumericArrayViewer;
	numFormatVal = nrf_dec;
...
arnNumericArrayViewer::~arnNumericArrayViewer(void)
{

}

void arnNumericArrayViewer::setXValue(int row, double val)
{
	//QString ts;
	if (!precX) {
		switch (numFormatX) {
...
void arnNumericArrayViewer::setValue(int row, double val)
{
   // QString ts;
	if (!prec) {
		switch (numFormatVal) {
...
QString arnNumericArrayViewer::text(int row)
{
    QString ts;
...
QString arnNumericArrayViewer::text(int row,int col)
{
    QString ts;
...
void arnNumericArrayViewer::contextMenuEvent ( QContextMenuEvent * e )
{
//arnDebug("Entrato\n");
...
// bool arnNumericArrayViewer::eventFilter(QObject* watched, QEvent* e)
// {
...
void arnNumericArrayViewer::Inizializza_Hndl(void)
{
    bool ok = false;
...
void arnNumericArrayViewer::Interpola_Hndl(void)
{
    if (pArray->isColumnSelected(pArray->currentColumn(),true)) {
...
void arnNumericArrayViewer::Azzera_Hndl(void)
{
    if (pArray->isColumnSelected(pArray->currentColumn(),true)) {
            for (int indx = 0; indx < pArray->numRows(); indx++) {
            setValue(indx,0);
...
void arnNumericArrayViewer::Aggiungi_Hndl(void)
{
    bool ok = false;
    double res = QInputDialog::getDouble(
        tr( "Aggiungi" ),
...
void arnNumericArrayViewer::Moltiplica_Hndl(void)
{
    bool ok = false;
    double res = QInputDialog::getDouble(
        tr( "Aggiungi" ),
...
void arnNumericArrayViewer::Nascondi_Hndl(void)
{
    if (pArray->isColumnSelected(pArray->currentColumn(),true)) {
        for (int indx = 0; indx < pArray->numRows(); indx++) {
            pArray->hideRow(indx);
...
void arnNumericArrayViewer::Mostratutti_Hndl(void)
{
    for (int indx = 0; indx < pArray->numRows(); indx++) {
        pArray->showRow(indx);
        }
...
void arnNumericArrayViewer::Copia_Hndl(void)
{
	QString aTxt("VECTOR\n");
	int minR, minC;
	minR = pArray->numRows();
...
void arnNumericArrayViewer::Incolla_Hndl(void)
{
...
void arnNumericArrayViewer::selectCells(int sRow, int eRow)
{
//	Q3TableSelection sel;
//	sel.init(sRow,1);
//	sel.expandTo(eRow,1);
...
void arnNumericArrayViewer::doValueChange(int row, int col)
{
    emit valueChanged(row,col);
}

void arnNumericArrayViewer::enterEvent(QEvent */*e*/)
{
	if (pClip) {
		if (pClip->supportsSelection()) {
