...
#ifndef ArnSliderGroupH
#define ArnSliderGroupH
...
class arnSliderGroup : public QFrame {
    ...
    protected:
        ...
        QList<arnSliderItem *> *SliderList;
        bool synchronized;
    ...
    public:
        ...
        *
        */
        arnSliderGroup(QWidget *parent = 0, const char* name = 0, Qt::WFlags f = 0);
        ...
        */
        inline double getSliderValue(int index) {
			if (index < int(SliderList->count()))
				return ((arnSliderItem *)SliderList->at(index))->sliderValue();
			return double(0);
			}
        ...
        */
        inline double getValue(int index) {
			if (index < int(SliderList->count()))
				return ((arnSliderItem *)SliderList->at(index))->value();
			return double(0);
			}
        ...
        */
        inline QString text(int index) {
			if (index < int(SliderList->count()))
				return ((arnSliderItem *)SliderList->at(index))->text();
			return QString("");
			}
        ...
        */
        inline QString getSliderName(int index) {
			if (index < int(SliderList->count()))
				return ((arnSliderItem *)SliderList->at(index))->name();
			}
	...
	public slots:
        ...
        */
        inline void setSliderMin(int index, int min) {
            if (index < int(SliderList->count()))
                ((arnSliderItem *)SliderList->at(index))->setSliderMin(min);
            }
        ...
        */
        inline void setSliderMax(int index, int max) {
            if (index < int(SliderList->count()))
                ((arnSliderItem *)SliderList->at(index))->setSliderMax(max);
            }
        ...
        */
        inline void setValueSize(int index,  NumericFixedFormat_t sz, char f = 'f' ,int pr = 3) {
            if (index < int(SliderList->count()))
                ((arnSliderItem *)SliderList->at(index))->setValueSize(sz,f,pr);
            }
        ...
        */
        inline void setValueMin(int index, double min) {
            if (index < int(SliderList->count()))
                ((arnSliderItem *)SliderList->at(index))->setValueMin(min);
            }
        ...
        */
        inline void setValueMax(int index,  double max) {
            if (index < int(SliderList->count()))
                ((arnSliderItem *)SliderList->at(index))->setValueMax(max);
            }
        ...
        */
        bool  isChannelVisible(int index) {
			if (index < int(SliderList->count())) {
				return ((arnSliderItem *)SliderList->at(index))->isVisibleTo(this);
				}
			return false;
			}
        ...
        */
        inline double ValueMin(int index) {
            if (index < int(SliderList->count()))
                return ((arnSliderItem *)SliderList->at(index))->ValueMin();
        ...
        */
        inline double ValueMax(int index) {
            if (index < int(SliderList->count()))
                return ((arnSliderItem *)SliderList->at(index))->ValueMax();
            else arnCriticalExit();
            }
        /*! \brief set the numeric value of a value minimum in the group for scaling\n
        *
        ...
        */
        inline int SliderMin(int index) {
            if (index < int(SliderList->count()))
                return ((arnSliderItem *)SliderList->at(index))->SliderMin();
            else arnCriticalExit();
            }
        ...
        */
        inline int SliderMax(int index) {
            if (index < int(SliderList->count()))
                return ((arnSliderItem *)SliderList->at(index))->SliderMax();
            else arnCriticalExit();
            }
		        /*! \brief update all the widget children of his\n
        *
		...
		*/
		void setVisible(int index,bool en) {
			if (index < int(SliderList->count()))
				((arnSliderItem *)SliderList->at(index))->setVisible(en);
			}
