/***************************************************************************
                          arnEngineAppMSTraceSliderGroup.h  -  description
                             -------------------
...
#ifndef ArnEngineAppMSTraceSliderGroupH
#define ArnEngineAppMSTraceSliderGroupH
...
class arnEngineAppMSTraceSliderGroup : public QFrame {
	Q_OBJECT
	private:
	protected:
		QVBoxLayout /*QGridLayout*/ *pVLayout;
		QList<arnEngineAppMSTraceSliderItem*> *SliderList;
		bool synchronized;
		bool mulSelEnabled; // enable the behaviour of multiple selection with device defined keyboard keys
    ...
    public:
        ...
        *
        */
        arnEngineAppMSTraceSliderGroup(QWidget *parent = 0, const char* name = 0, Qt::WFlags f = 0);

        /*! \brief default destructor\n
        *
        */
        ~arnEngineAppMSTraceSliderGroup(void);
        ...
        */
        inline double getSliderValue(int index) {
			if (index < int(SliderList->count()))
				return ((arnEngineAppMSTraceSliderItem *)SliderList->at(index))->sliderValue();
			return double(0);
			}
        ...
        */
        inline double getValue(int index) {
			if (index < int(SliderList->count()))
				return ((arnEngineAppMSTraceSliderItem *)SliderList->at(index))->value();
			return double(0);
			}
        ...
        */
        inline QString text(int index) {
			if (index < int(SliderList->count()))
				return ((arnEngineAppMSTraceSliderItem *)SliderList->at(index))->text();
			return QString("");
			}
        ...
        */
        inline QString getSliderName(int index) {
			if (index < int(SliderList->count()))
				return ((arnEngineAppMSTraceSliderItem *)SliderList->at(index))->name();
			}
	...
	public slots:
        ...
        */
        inline void setSliderMin(int index, int min) {
            if (index < int(SliderList->count()))
                ((arnEngineAppMSTraceSliderItem *)SliderList->at(index))->setSliderMin(min);
            }
        ...
        */
        inline void setSliderMax(int index, int max) {
            if (index < int(SliderList->count()))
                ((arnEngineAppMSTraceSliderItem *)SliderList->at(index))->setSliderMax(max);
            }
        ...
        */
        ...
        /*! \brief set the Multiple selection property in the slider group\n
        *
        * @param msf is truth value for setting  Multiple selection property.
        *
        * Ex:\n
        * ...\n
        */
        inline void setMulSelEnabled(bool msf) {mulSelEnabled = msf;}
		
        /*! \brief get the sychronized property in the slider group\n
        *
        * @return true if the group allows multiple selection, false otehrwise
        *
        * Ex:\n
        * ...\n
        */
        inline bool MulSelEnabled(void) {return mulSelEnabled;}
        ...
        */
        inline void setValueSize(int index,  NumericFixedFormat_t sz, char f = 'f' ,int pr = 3) {
            if (index < int(SliderList->count()))
                ((arnEngineAppMSTraceSliderItem *)SliderList->at(index))->setValueSize(sz,f,pr);
            }
        ...
        */
        inline void setValueMin(int index, double min) {
            if (index < int(SliderList->count()))
                ((arnEngineAppMSTraceSliderItem *)SliderList->at(index))->setValueMin(min);
            }
        ...
        */
        inline void setValueMax(int index,  double max) {
            if (index < int(SliderList->count()))
                ((arnEngineAppMSTraceSliderItem *)SliderList->at(index))->setValueMax(max);
            }
        ...
        */
        bool  isChannelVisible(int index) {
			if (index < int(SliderList->count())) {
				return ((arnEngineAppMSTraceSliderItem *)SliderList->at(index))->isVisibleTo(this);
				}
			return false;
			}
        ...
        */
        inline double ValueMin(int index) {
            if (index < int(SliderList->count()))
                return ((arnEngineAppMSTraceSliderItem *)SliderList->at(index))->ValueMin();
        ...
        */
        inline double ValueMax(int index) {
            if (index < int(SliderList->count()))
                return ((arnEngineAppMSTraceSliderItem *)SliderList->at(index))->ValueMax();
            else arnCriticalExit();
            }
        /*! \brief set the numeric value of a value minimum in the group for scaling\n
        *
        ...
        */
        inline int SliderMin(int index) {
            if (index < int(SliderList->count()))
                return ((arnEngineAppMSTraceSliderItem *)SliderList->at(index))->SliderMin();
            else arnCriticalExit();
            }
        ...
        */
        inline int SliderMax(int index) {
            if (index < int(SliderList->count()))
                return ((arnEngineAppMSTraceSliderItem *)SliderList->at(index))->SliderMax();
            else arnCriticalExit();
            }
        ...
        */
        inline void setReplaceObject(int index,arnSObjectContainer *pRo) {
            if (index < int(SliderList->count())) ((arnEngineAppMSTraceSliderItem *)SliderList->at(index))->setReplaceObject(pRo);
            else arnCriticalExit();
            }
        ...
        */
        arnSObjectContainer *replaceObject(int index) {
            if (index < int(SliderList->count()))
                return ((arnEngineAppMSTraceSliderItem *)SliderList->at(index))->replaceObject();
            else arnCriticalExit();
            }
        ...
        */
		...
		/*! \brief set the Multiple selection key for increse the slider\n
        *
        * It shows the channel index.
        *
        * Ex:\n
        * ...\n
        */
        void setMulSelKeyUP(int index, Qt::Key K) {
            if (index < int(SliderList->count()))
                return ((arnEngineAppMSTraceSliderItem *)SliderList->at(index))->setMulSelKeyUP(K);
            else arnCriticalExit();
            }
        ...
        * ...\n
        */
        void setMulSelKeyUP(const char* Label, Qt::Key K);

		/*! \brief set the Multiple selection key for decrease the slider\n
        *
        * It shows the channel index.
        *
        * Ex:\n
        * ...\n
        */
        void setMulSelKeyDOWN(int index, Qt::Key K) {
            if (index < int(SliderList->count()))
                return ((arnEngineAppMSTraceSliderItem *)SliderList->at(index))->setMulSelKeyDOWN(K);
            else arnCriticalExit();
            }
        ...
        * ...\n
        */
        void setMulSelKeyDOWN(const char* Label, Qt::Key K);
        ...
        * ...\n
        */
        bool isTraceEnabled(const char* Label);
		...
		*/
		void setVisible(int index,bool en) {
			if (index < int(SliderList->count()))
				((arnEngineAppMSTraceSliderItem *)SliderList->at(index))->setVisible(en);
			}
