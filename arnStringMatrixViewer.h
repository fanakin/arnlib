/***************************************************************************
						  arnStringMatrixViewer.h  -  description
                             -------------------
...
#ifndef ArnStringMatrixViewerH
#define ArnStringMatrixViewerH
...
class arnStringMatrixViewer : public arnObjectViewer
{
    Q_OBJECT
    ...
    public :
		...
		arnStringMatrixViewer(QWidget *parent = 0, const char *name = 0, Qt::WFlags f = 0);
		arnStringMatrixViewer(int rows = 5, int cols = 5, QWidget *parent = 0, const char *name = 0, Qt::WFlags f = 0);
		~arnStringMatrixViewer(void);
