/***************************************************************************
                          arnPVINumericMatrix.h  -  description
                             -------------------
...
#ifndef ArnPVINumericMatrixH
#define ArnPVINumericMatrixH
...
// ***************************************************
// ---------------------------------------------------
class arnPVINumericMatrix : public arnPVIMatrix
{
    Q_OBJECT
    ...
    public:
		arnPVINumericMatrix ( QObject * Opar, Q3ListView * parent );
        arnPVINumericMatrix ( QObject * Opar, Q3ListViewItem *parent );
        arnPVINumericMatrix ( QObject * Opar, Q3ListView *parent, Q3ListViewItem *after );
        arnPVINumericMatrix ( QObject * Opar, Q3ListViewItem *parent, Q3ListViewItem *after );
        arnPVINumericMatrix ( QObject * Opar, Q3ListView *parent,
        ...
        arnPVINumericMatrix ( QObject * Opar, Q3ListViewItem *parent, Q3ListViewItem *after,
			...
			QString label4 = QString::null, QString label5 = QString::null, QString label6 = QString::null,
			QString label7 = QString::null, QString label8 = QString::null );
        virtual ~arnPVINumericMatrix(void);
