/***************************************************************************
                          arnEngineZAppSliderGroup.h  -  description
                             -------------------
...
#ifndef ArnEngineZAppSliderGroupH
#define ArnEnginZeAppSliderGroupH
...
class arnEngineZAppSliderGroup : public QFrame {
    ...
    protected:
        ...
        QList<arnEngineZAppSliderItem *> *SliderList;
        bool synchronized;
    ...
    public:
        ...
        *
        */
        arnEngineZAppSliderGroup(QWidget *parent = 0, const char* name = 0, Qt::WFlags f = 0);

        /*! \brief default destructor\n
        *
        */
        ~arnEngineZAppSliderGroup(void);
        ...
        */
        inline double getValue(int index) {
			if (index < int(SliderList->count()))
				return ((arnEngineZAppSliderItem *)SliderList->at(index))->value();
			return double(0);
			}
        ...
        */
        inline QString text(int index) {
			if (index < int(SliderList->count()))
				return ((arnEngineZAppSliderItem *)SliderList->at(index))->text();
			return QString("");
			}
        ...
        */
        inline QString getSliderName(int index) {
			if (index < int(SliderList->count()))
				return ((arnEngineZAppSliderItem *)SliderList->at(index))->name();
			}
	...
	public slots:
        ...
        */
        inline void setSliderMin(int index, int min) {
            if (index < int(SliderList->count()))
                ((arnEngineZAppSliderItem *)SliderList->at(index))->setSliderMin(min);
            }
        ...
        */
        inline void setSliderMax(int index, int max) {
            if (index < int(SliderList->count()))
                ((arnEngineZAppSliderItem *)SliderList->at(index))->setSliderMax(max);
            }
        ...
        */
        inline void setValueSize(int index,  NumericFixedFormat_t sz, char f = 'f' ,int pr = 3) {
            if (index < int(SliderList->count()))
                ((arnEngineZAppSliderItem *)SliderList->at(index))->setValueSize(sz,f,pr);
            }
        ...
        */
        inline void setValueMin(int index, double min) {
            if (index < int(SliderList->count()))
                ((arnEngineZAppSliderItem *)SliderList->at(index))->setValueMin(min);
            }
        ...
        */
        inline void setValueMax(int index,  double max) {
            if (index < int(SliderList->count()))
                ((arnEngineZAppSliderItem *)SliderList->at(index))->setValueMax(max);
            }
        ...
        */
        bool  isChannelVisible(int index) {
			if (index < int(SliderList->count())) {
				return ((arnEngineZAppSliderItem *)SliderList->at(index))->isVisibleTo(this);
				}
			return false;
			}
        ...
        */
        inline double ValueMin(int index) {
            if (index < int(SliderList->count()))
                return ((arnEngineZAppSliderItem *)SliderList->at(index))->ValueMin();
        ...
        */
        inline double ValueMax(int index) {
            if (index < int(SliderList->count()))
                return ((arnEngineZAppSliderItem *)SliderList->at(index))->ValueMax();
            else arnCriticalExit();
            }
        /*! \brief set the numeric value of a value minimum in the group for scaling\n
        *
        ...
        */
        inline int SliderMin(int index) {
            if (index < int(SliderList->count()))
                return ((arnEngineZAppSliderItem *)SliderList->at(index))->SliderMin();
            else arnCriticalExit();
            }
        ...
        */
        inline int SliderMax(int index) {
            if (index < int(SliderList->count()))
                return ((arnEngineZAppSliderItem *)SliderList->at(index))->SliderMax();
            else arnCriticalExit();
            }
        ...
        */
        inline void setReplaceObject(int index,arnSObjectContainer *pRo) {
            if (index < int(SliderList->count())) ((arnEngineZAppSliderItem *)SliderList->at(index))->setReplaceObject(pRo);
            else arnCriticalExit();
            }
        ...
        */
        arnSObjectContainer *replaceObject(int index) {
            if (index < int(SliderList->count()))
                return ((arnEngineZAppSliderItem *)SliderList->at(index))->replaceObject();
            else arnCriticalExit();
            }
		...
		*/
		void setVisible(int index,bool en) {
			if (index < int(SliderList->count()))
				((arnEngineZAppSliderItem *)SliderList->at(index))->setVisible(en);
			}
