/***************************************************************************
                          arnPVI8BitExpandValueMatrix.h  -  description
                             -------------------
...
#ifndef ArnPVI8BitExpandValueMatrixH
#define ArnPVI8BitExpandValueMatrixH
#include "arnPVINumericArray.h"
#include "arnPVIMatrix.h"
// ---------------------------------------------------
// ***************************************************
// --------- arnPVI8BitExpandValueMatrix ---------------------
// ***************************************************
// ---------------------------------------------------

class arnPVI8BitExpandValueMatrix : public arnPVIMatrix
{
	Q_OBJECT
	...
	public:
		arnPVI8BitExpandValueMatrix ( QObject * Opar, Q3ListView * parent );
		arnPVI8BitExpandValueMatrix ( QObject * Opar, Q3ListViewItem *parent );
		arnPVI8BitExpandValueMatrix ( QObject * Opar, Q3ListView *parent, Q3ListViewItem *after );
		arnPVI8BitExpandValueMatrix ( QObject * Opar, Q3ListViewItem *parent, Q3ListViewItem *after );
		arnPVI8BitExpandValueMatrix ( QObject * Opar, Q3ListView *parent,
		...
		arnPVI8BitExpandValueMatrix ( QObject * Opar, Q3ListViewItem *parent, Q3ListViewItem *after,
			...
			QString label4 = QString::null, QString label5 = QString::null, QString label6 = QString::null,
			QString label7 = QString::null, QString label8 = QString::null );
		virtual ~arnPVI8BitExpandValueMatrix(void);
	public slots:
